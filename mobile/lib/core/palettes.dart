...
const lumaPalettes = <LumaPalette>[
  ...
  LumaPalette(
    ...
    isDark: false,
    brand: Color(0xFF3B5BDB),
    brandHover: Color(0xFF2F49AF),
    brandLight: Color(0xFF5C7CFA),
    onBrand: Color(0xFFFFFFFF),
    bgApp: Color(0xFFFAF9F6),
    bgCanvas: Color(0xFFF5F3EE),
    bgSurface: Color(0xFFFFFFFF),
    bgSurface2: Color(0xFFFBFAF7),
    bgElevated: Color(0xFFFFFFFF),
    textPrimary: Color(0xFF1A1815),
    textSecondary: Color(0xFF4A463F),
    textMuted: Color(0xFF8A847A),
    border: Color(0xFFE7E3DA),
    borderStrong: Color(0xFFD3CDC0),
    danger: Color(0xFFF87171),
    warning: Color(0xFFFBBF24),
    info: Color(0xFF60A5FA),
    success: Color(0xFF34D399),
  ...
  LumaPalette(
    ...
    icon: Icons.circle,
    isDark: true,
    brand: Color(0xFF4D8DFF),
    brandHover: Color(0xFF3B72D9),
    brandLight: Color(0xFF7AAAFF),
    onBrand: Color(0xFF04101F),
    bgApp: Color(0xFF000000),
    bgCanvas: Color(0xFF050505),
    bgSurface: Color(0xFF0D0D0D),
    bgSurface2: Color(0xFF141414),
    bgElevated: Color(0xFF171717),
